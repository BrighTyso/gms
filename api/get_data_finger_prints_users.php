...
$userid=$_GET['userid'];
    ...
    $sql1 = "Select distinct feature,description from user_finger_print  order by rand() ";
   ...
   if ($result1->num_rows > 0) {
     ...
     while($row1 = $result1->fetch_assoc()) {
      ...
      $temp=array("grower_num"=>$row1["description"],"feature"=>$row1["feature"],"seasonid"=>$seasonid);
