...
$weather_condition=$_GET['weather_condition'];
 $temperature=$_GET['temperature'];
  $humidity=$_GET['humidity'];
  $rain_risk=$_GET['rain_risk'];

//  datetimes,
// seasonid, weather_condition, temperature, humidity,rain_risk
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO harvesting_weather(userid, growerid, latitude, longitude, created_at, datetimes,
seasonid, weather_condition, temperature, humidity,rain_risk) VALUES ($userid, $growerid, '$latitude','$longitude','$created_at', '$datetimes',
$seasonid, '$weather_condition', '$temperature', '$humidity','$rain_risk')";
