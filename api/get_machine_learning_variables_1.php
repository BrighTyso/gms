   ...
   while($row = $result->fetch_assoc()) {
    ...
    $growerid=$row["id"];
        ...
        $result1 = $conn->query($sql1);
         ...
         $temp=array("growerid"=>$growerid,"grower_num"=>$grower_num,"basal_quantity"=>$basal_quantity,"an_quantity"=>$an_quantity,"potasium_quantity"=>$potasium_quantity,"basal_mass"=>$basal_mass,"an_mass"=>$an_mass,"potasium_mass"=>$potasium_mass,"no_of_plants"=>$number_of_plants ,"home_latitude"=>$home_latitude,"home_longitude"=>$home_longitude,"temp"=>$temp,"temp_min"=>$temp_min,"temp_max"=>$temp_max,"pressure"=>$pressure,"humidity"=>$humidity ,"rain"=>$rain,"clouds"=>$clouds,"wind_speed"=>$wind_speed);
