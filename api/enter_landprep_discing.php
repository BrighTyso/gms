...
$discingOptions=validate($_GET['discingOptions']);
$dateOfDiscing=validate($_GET['dateOfDiscing']);
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO landprep_discing(userid,  growerid,  latitude,  longitude,  created_at,  seasonid,  discingOptions,  
dateOfDiscing,datetimes) VALUES ($userid,  $growerid,  '$latitude',  '$longitude',  '$created_at',  $seasonid,  '$discingOptions',  
'$dateOfDiscing','$datetimes')";
