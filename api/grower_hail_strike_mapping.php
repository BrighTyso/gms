...
//check farm
$sql1 = "Select id from hail_strike_mapping  where  growerid=$growerid and seasonid=$seasonid";
$result = $conn->query($sql1);
 ...
 if ($response==1 && $farm_response==0){
	...
	$grower_farm_sql = "INSERT INTO hail_strike_mapping(userid,seasonid,growerid,first_lat,first_long,second_lat,second_long,third_lat,third_long,forth_lat,forth_long,created_at) VALUES ($userid,$seasonid,$growerid,'$first_lat','$first_long','$second_lat','$second_long','$third_lat','$third_long','$forth_lat','$forth_long','$created_at')";
