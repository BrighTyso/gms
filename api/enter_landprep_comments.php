...
$landprep_comment1=validate($_GET['landprep_comment1']);
$landprep_comment2=validate($_GET['landprep_comment2']);
$landprep_comment3=validate($_GET['landprep_comment3']);
$landprep_comment4=validate($_GET['landprep_comment4']);

$landprep_comment5=validate($_GET['landprep_comment5']);
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO landprep_comments(userid,  seasonid,  growerid,  latitude,  longitude,  created_at,  landprep_comment1,  
landprep_comment2,  landprep_comment3,  landprep_comment4,  landprep_comment5,datetimes) VALUES ($userid,$seasonid,$growerid,  '$latitude',  '$longitude',  '$created_at','$landprep_comment1',  
'$landprep_comment2',  '$landprep_comment3',  '$landprep_comment4',  '$landprep_comment5','$datetimes')";
