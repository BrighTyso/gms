...
$sql = "Select distinct dispatch_note.id,note,horse_num,trailer_num,dispatch_note_total_dispatched.quantity as dispatch_quantity,dispatch_note_total_received.quantity as received_bales,name from dispatch_note join dispatch_note_total_dispatched on dispatch_note.id=dispatch_note_total_dispatched.dispatch_noteid join dispatch_note_total_received on dispatch_note.id=dispatch_note_total_received.dispatch_noteid join users on dispatch_note.receiverid=users.id where dispatch_note.seasonid=$seasonid  and (dispatch_note.receiverid=$userid) and (trailer_num='$description' or horse_num='$description' or note='$description' or name='$description' or surname='$description'  or username='$description' or dispatch_note.id=$description)  " ;
