...
$sql = "Select * from bale_tags where grower_number_of_balesid=$grower_number_of_balesid";
$result = $conn->query($sql);
 ...
 if ($result->num_rows > 0) {
   ...
   $temp=array("code"=>$row["code"],"used"=>$row["used"],"id"=>$row["id"],"created_at"=>$row["created_at"]);
