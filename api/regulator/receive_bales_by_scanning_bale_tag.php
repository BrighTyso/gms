...
if (isset($_POST['barcode']) && isset($_POST['qrcode']) && isset($_POST['userid'])  && isset($_POST['latitude']) && isset($_POST['longitude']) && isset($_POST["company_to_selling_pointid"])&& isset($_POST["company_userid"])){
...
if ($barcode_found>0) {
  ...
  $insert_sql = "INSERT INTO bale_receiver(userid,bale_tagid,latitude,longitudecompany_userid,company_to_selling_pointid) VALUES ($userid,$barcode_found,'$latitude','$longitude',$company_userid,$company_to_selling_pointid)";
