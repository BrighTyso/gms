...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO fertilization_potassium(userid,seasonid,growerid,latitude,longitude,kg_per_ha,created_at) VALUES ($userid,$growerid,$seasonid,'$lat','$long','$kg_per_ha','$created_at')";
