...
$observed_mold=$_GET['observed_mold'];
$drainage=$_GET['drainage'];
$flood_risk=$_GET['flood_risk'];
$wind_vulnerability=$_GET['wind_vulnerability'];
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO barn_environment(userid, 
growerid, 
latitude, 
longitude, 
created_at, 
