...
$sql = "Select * from users where id=$userid and  active=1";
...
if ($rule==0) {
        ...
        $sql = "Select name,surname,grower_num,growers.userid,area,province,phone,id_num,growers.created_at,growers.seasonid from growers where grower_num='$description'";
        $result = $conn->query($sql);
