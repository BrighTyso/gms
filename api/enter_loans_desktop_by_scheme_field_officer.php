...
$sql2 = "Select users.id from grower_field_officer join users on users.id=grower_field_officer.field_officerid where username='$field_officer' or name='$field_officer' or surname='$field_officer'";
