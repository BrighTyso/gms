...
$overall_status=$_GET['overall_status']; 
$crop_pop_remarks=$_GET['crop_pop_remarks'];
$crop_pop_recommendations=$_GET['crop_pop_recommendations'];
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO crop_population_remarks(userid, 
growerid, 
latitude, 
longitude, 
created_at, 
...
overall_status, 
crop_pop_remarks, 
crop_pop_recommendations) VALUES ($userid, 
$growerid, 
'$latitude', 
'$longitude', 
'$created_at', 
