...
$field_name=validate($_GET['field_name']);
$transplant_vigor=validate($_GET['transplant_vigor']);
$transplant_root_health=validate($_GET['transplant_root_health']);
$transplant_diseases=validate($_GET['transplant_diseases']);


$transplant_pests=validate($_GET['transplant_pests']);
$transplant_weeds=validate($_GET['transplant_weeds']);
$transplant_survival_rate=validate($_GET['transplant_survival_rate']);
