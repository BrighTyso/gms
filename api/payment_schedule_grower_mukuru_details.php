...
if (isset($data->userid)){
  ...
  $sql ="Select * from payment_schedule_grower_mukuru_details where  grower_payment_scheduleid=$grower_payment_scheduleid and bank_detailsid=$bank_detailsid and currencyid=$currencyid";
  $result = $conn->query($sql);
 ...
 if ($payment_details_found==0) {
   ...
   $user_sql = "INSERT INTO payment_schedule_grower_mukuru_details(userid,seasonid,bank_detailsid,currencyid,grower_payment_scheduleid,account) VALUES ($userid,$seasonid,$bank_detailsid,$currencyid,$grower_payment_scheduleid,'$account')";
