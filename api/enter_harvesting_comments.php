...
$harvest_timing_remark=$_GET['harvest_timing_remark'];
$handling_remark=$_GET['handling_remark'];
$quality_remark=$_GET['quality_remark'];
$expected_grade_remark=$_GET['expected_grade_remark'];

// userid, growerid, latitude, longitude, created_at, datetimes,seasonid, harvest_timing_remark, 
// handling_remark, quality_remark,expected_grade_remark
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO harvesting_comments(userid, growerid, latitude, longitude, created_at, datetimes,seasonid, harvest_timing_remark, 
handling_remark, quality_remark,expected_grade_remark) VALUES ($userid,  $growerid,  '$latitude',  '$longitude',  '$created_at', '$datetimes',$seasonid, '$harvest_timing_remark', 
'$handling_remark', '$quality_remark','$expected_grade_remark')";
   ...
   if ($conn->query($insert_sql)===TRUE) {
    ...
    // $last_id = $conn->insert_id;
     ...
     $insert_sql = "insert into visits(userid,growerid,seasonid,latitude,longitude,created_at,description,times) value($userid,$growerid,$seasonid,'$latitude','$longitude','$created_at','harvesting comments','$datetimes');";
       //$gr = "select * from login";
       if ($conn->query($insert_sql)===TRUE) {
