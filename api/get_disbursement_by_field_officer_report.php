...
$disbursement_products_data=array();
...
$sql13 = "Select * from disbursement_products join products on products.id=disbursement_products.productid where created_at='$created_at' order by disbursement_products.productid";
    ...
    $result3 = $conn->query($sql13);
     ...
     if ($result3->num_rows > 0) {
       ...
       while($row3 = $result3->fetch_assoc()) {
        ...
        $loans=array("name"=>$row3["name"],"id"=>$row3["id"]);
          array_push($disbursement_products_data,$loans);
