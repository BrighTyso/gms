...
$sql = "Select * from grower_signatures join growers on growers.id=grower_signatures.growerid  where growers.grower_num='$grower_num' and grower_signatures.seasonid=$seasonid and grower_signatures.created_at='$created_at'";
 ...
 if ($result->num_rows > 0) {
   ...
   while($row = $result->fetch_assoc()) {
    // echo "id: " . $row["id"]. " - Name: " . $row["firstname"]. " " . $row["lastname"]. "<br>";
     ...
     $temp=array("id"=>$row["id"],"image_location"=>$row["image_location"]);
