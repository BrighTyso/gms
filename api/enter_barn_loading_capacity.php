...
$tiers_poles_condition=$_GET['tiers_poles_condition'];
$tier_spacing=$_GET['tier_spacing']; 
$barn_capacity=$_GET['barn_capacity'];
$overloading_risk=$_GET['overloading_risk'];
$unloading_safety=$_GET['unloading_safety'];
$barn_ha_capacity=$_GET['barn_ha_capacity'];
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO barn_loading_capacity(userid, 
growerid, 
latitude, 
longitude, 
created_at, 
...
overloading_risk,
unloading_safety,
barn_ha_capacity) VALUES ($userid, 
$growerid, 
'$latitude', 
'$longitude', 
'$created_at', 
...
'$barn_ha_capacity')";
   ...
   if ($conn->query($insert_sql)===TRUE) {
    ...
    // $last_id = $conn->insert_id;
     ...
     $insert_sql = "insert into visits(userid,growerid,seasonid,latitude,longitude,created_at,description,times) value($userid,$growerid,$seasonid,'$latitude','$longitude','$created_at','barn loading capacity','$datetimes');";
       //$gr = "select * from login";
       if ($conn->query($insert_sql)===TRUE) {
