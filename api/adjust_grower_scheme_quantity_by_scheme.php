...
//disbursed_products_grower_truck

$loan_adjusted=0;

$sql = "Select distinct disbursed_products_grower_truck.id,disbursed_products_grower_truck.disbursement_trucksid,disbursed_products_grower_truck.quantity,disbursed_products_grower_truck.adjustment_quantity from disbursed_products_grower_truck  where disbursed_products_grower_truck.growerid=$growerid and disbursed_products_grower_truck.productid=$productid  and (disbursed_products_grower_truck.quantity=$quantity or disbursed_products_grower_truck.adjustment_quantity=$quantity) and disbursed_products_grower_truck.seasonid=$seasonid  limit 1";
   ...
   if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
      ...
      $disbursement_trucksid=$row["disbursement_trucksid"];
        ...
        if ($row["adjustment_quantity"]==0) {

            $disbusment_quantity=$row["quantity"];
            $loan_adjusted=0;

        }else{
            $disbusment_quantity=$row["adjustment_quantity"];
            $loan_adjusted=1;
        }
      ...
      if ($quantity>$newquantity) {
        ...
        $user_sql1 = "update loans set quantity=$newquantity  where id=$loanid";
           ...
           if ($conn->query($user_sql1)===TRUE) {
               ...
               //     //$sql = "select * from login";
               //     if ($conn->query($user_sql1)===TRUE) {
                    $user_sql1 = "update disbursed_products_grower_truck set adjustment_quantity=$newquantity,adjust=1  where disbursement_trucksid=$disbursement_trucksid and productid=$productid and growerid=$growerid";
