...
$curing_stage=$_GET['curing_stage']; 
$curing_remarks=$_GET['curing_remarks'];
...
$insert_sql = "INSERT INTO curing_comments(userid,  
growerid,  
latitude,  
longitude,  
created_at,  
...
'$datetimes')";
   ...
   if ($conn->query($insert_sql)===TRUE) {
    ...
    // $last_id = $conn->insert_id;
     ...
     $insert_sql = "insert into visits(userid,growerid,seasonid,latitude,longitude,created_at,description,times) value($userid,$growerid,$seasonid,'$latitude','$longitude','$created_at','curing comments','$datetimes');";
       //$gr = "select * from login";
       if ($conn->query($insert_sql)===TRUE) {
