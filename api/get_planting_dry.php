...
if ($userid!="") {
  $sql = "select ha_planted_to_date,date_of_plant,crop_stand_perc,crop_unifomity_perc,created_at from planting_dryLand where growerid=$growerid and seasonid=$seasonid order by created_at desc limit 1 ";
