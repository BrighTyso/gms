...
if (isset($data->storeid) && isset($data->userid) && isset($data->receiverid)) {
  
        $receiverid=$data->receiverid;
        $userid=$data->userid;
        $storeid=$data->storeid;
 
        $sql = "Select * from user_to_store where loan_userid=$receiverid and active=1 limit 1";
        ...
        if ($found==0) {
          ...
          $user_sql2 = "INSERT INTO user_to_store(userid,loan_userid,storeid) VALUES ($userid,$receiverid,$storeid)";
