...
$lamina_start_date = $_GET['lamina_start_date'];
$lamina_end_date = $_GET['lamina_end_date'];
$lamina_temperature = $_GET['lamina_temperature'];
$lamina_ventilation = $_GET['lamina_ventilation'];
$lamina_uniformity = $_GET['lamina_uniformity'];
$lamina_texture = $_GET['lamina_texture'];
$color_fixed = $_GET['color_fixed'];
$over_drying = $_GET['over_drying'];
$lamina_status = $_GET['lamina_status'];
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO lamina_stage (
    userid, 
    growerid, 
    latitude, 
    longitude, 
   ...
   if ($conn->query($insert_sql)===TRUE) {
    ...
    // $last_id = $conn->insert_id;
     ...
     $insert_sql = "insert into visits(userid,growerid,seasonid,latitude,longitude,created_at,description,times) value($userid,$growerid,$seasonid,'$latitude','$longitude','$created_at','lamina stage','$datetimes');";
       //$gr = "select * from login";
       if ($conn->query($insert_sql)===TRUE) {
