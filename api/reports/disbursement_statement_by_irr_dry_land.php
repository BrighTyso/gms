...
$sql11 = "Select distinct growers.id,growers.name,growers.surname,growers.grower_num,growers.area,growers.id_num from  growers join active_growers on active_growers.growerid=growers.id join land_irrigation_growers on land_irrigation_growers.growerid=growers.id where active_growers.seasonid=$seasonid and land_irrigation_growers.land_irrigation_growers_typeid=$landid  order by active_growers.id";
...
$sql11 = "Select distinct growers.id,growers.name,growers.surname,growers.grower_num,growers.area,growers.id_num from  growers join active_growers on active_growers.growerid=growers.id join land_irrigation_growers on land_irrigation_growers.growerid=growers.id where active_growers.seasonid=$seasonid and land_irrigation_growers.land_irrigation_growers_typeid=$landid and (name ='$description' or grower_num='$description' or province='$description' or area='$description') limit 200";
