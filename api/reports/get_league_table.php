...
$company_details_data=array();
 ...
 $sql13 = "Select * from company_details_and_contact limit 1";
  ...
  $sql = "Select distinct users.username,users.id,target_points from users join total_points_earned on total_points_earned.userid=users.id where users.active=1 and total_points_earned.seasonid=$seasonid order by points ";
 ...
 if ($result->num_rows > 0) {
   ...
   while($row = $result->fetch_assoc()) {
    // echo "id: " . $row["id"]. " - Name: " . $row["firstname"]. " " . $row["lastname"]. "<br>";
      ...
      $sql2 = "Select distinct points,target_points,weekly_points_earned.start_date from weekly_points_earned where weekly_points_earned.userid=$userid and weekly_points_earned.start_date between '$start_date' and '$end_date'";
...
$temp=array("company_data"=>$company_details_data,"data"=>$data1);
