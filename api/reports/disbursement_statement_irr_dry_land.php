...
$result1 = $conn->query($sql11);
 ...
 if ($result1->num_rows > 0) {
   ...
   while($row1 = $result1->fetch_assoc()) {
    ...
    $sql2 = "Select * from grower_field_officer join users on users.id=grower_field_officer.field_officerid where growerid=$growerid and seasonid=$seasonid";
     ...
     if ($result->num_rows > 0) {
       ...
       while($row = $result->fetch_assoc()) {
        ...
        $sql123 = "Select distinct description,quantity,price from itemized_product join product_items on product_items.id=itemized_product.product_itemid where itemized_product.seasonid=$seasonid and itemized_product.productid=$product_id";
          ...
          $product_scheme_quantity=$row["quantity"];
          $disbursed_quantity=0;


          $sql123 = "Select distinct * from grower_disbursed_products where grower_disbursed_products.seasonid=$seasonid and grower_disbursed_products.productid=$product_id and growerid=$growerid";
          ...
          $result23 = $conn->query($sql123);
           ...
           if ($result23->num_rows > 0) {
             ...
             while($row3 = $result23->fetch_assoc()) {
              ...
              $disbursed_quantity+=$row3["quantity"];
...
$sql11 = "Select distinct growers.id,growers.name,growers.surname,growers.grower_num,growers.area,growers.id_num from  growers join active_growers on active_growers.growerid=growers.id join grower_field_officer on grower_field_officer.growerid=growers.id join grower_field_officer_groups on grower_field_officer_groups.growerid=growers.id join grower_groups on grower_groups.id=grower_field_officer_groups.grower_groupid where active_growers.seasonid=$seasonid and grower_groups.description='$groups'";
...
$sql11 = "Select distinct growers.id,growers.name,growers.surname,growers.grower_num,growers.area,growers.id_num from  growers join active_growers on active_growers.growerid=growers.id join grower_field_officer on grower_field_officer.growerid=growers.id join grower_field_officer_groups on grower_field_officer_groups.growerid=growers.id where active_growers.seasonid=$seasonid and grower_field_officer_groups.field_officerid=$officerid and grower_field_officer_groups.grower_groupid=$groupid";
