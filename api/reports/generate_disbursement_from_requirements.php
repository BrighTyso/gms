...
$sql = "Select distinct grower_field_loans.id as loanid,products.id as productid,growers.name,growers.id,growers.surname,growers.grower_num,products.name as product_name,grower_field_loans.quantity,units,package_units,grower_field_loans.created_at, users.username,farmer_comment,adjustment_quantity,grower_field_loans.hectares,adjust  from grower_field_loans join growers on growers.id=grower_field_loans.growerid join products on grower_field_loans.productid=products.id  join users on users.id=grower_field_loans.userid join total_disbursement on total_disbursement.productid=products.id  where grower_field_loans.seasonid=$seasonid and total_disbursement.disbursement_trucksid=$disbursement_truckid and grower_field_loans.growerid=$growerid order by grower_num ";
$result = $conn->query($sql);
