...
$sql = "Select disbursed_products_grower_truck.id,disbursed_products_grower_truck.disbursement_trucksid,disbursement.quantity from disbursed_products_grower_truck join truck_disbursment_sync_active on truck_disbursment_sync_active.disbursement_trucksid=disbursed_products_grower_truck.disbursement_trucksid join disbursement on disbursement.disbursement_trucksid=truck_disbursment_sync_active.disbursement_trucksid where disbursed_products_grower_truck.growerid=$growerid and disbursed_products_grower_truck.productid=$productid  and truck_to_grower.quantity=$quantity and seasonid=$seasonid and disbursed_products_grower_truck.loanid=$loanid  limit 1";
  ...
  if ($growerid>0 && $truck_to_growerid>0 && $disbursement_trucksid>0 && $loanid>0) {
      ...
      if ($quantity>$newquantity) {
        ...
        $user_sql1 = "update loans set quantity=$newquantity  where growerid=$growerid and productid=$productid  id=$loanid";
