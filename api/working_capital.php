...
$sql = "Select * from working_capital where receipt_number='$receipt' and seasonid=$seasonid";
$result = $conn->query($sql);
...
// then insert loan
  ...
  if ($growerid>0 && $receipt_found==0) {
   ...
   $insert_sql = "INSERT INTO working_capital(userid,seasonid,growerid,receipt_number,amount,created_at) VALUES ($userid,$seasonid,$growerid,'$receipt','$amount','$created_at')";
   ...
   if ($conn->query($insert_sql)===TRUE) {
    ...
    // $last_id = $conn->insert_id;
       ...
       if ($working_capital_found==0) {
                 ...
                 $user_sql = "INSERT INTO working_capital_total(userid,seasonid,growerid,amount) VALUES ($userid,$seasonid,$growerid,'$amount')";
                   //$sql = "select * from login";
                      ...
                      $user_sql2 = "update working_capital_total set amount=amount+$amount where growerid = $growerid and seasonid=$seasonid";
                     //$sql = "select * from login";
