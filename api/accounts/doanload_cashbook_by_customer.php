...
FROM
    ...
    join accounts_receivable_notes on accounts_receivable_notes.id=t.receivable_note_id join customers on customers.id=accounts_receivable_notes.customer_id join growers on customers.growerid=growers.id 
WHERE
    ...
    and (growers.grower_num='$description' or growers.name='$description' or growers.surname='$description') and t.seasonid=$seasonid 
