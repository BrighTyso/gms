...
$hectarage=$_GET['hectarage'];
$variety=$_GET['variety'];
$crop_pop_rate=$_GET['crop_pop_rate'];
$num_of_plants=$_GET['num_of_plants'];
$estimated_yield=$_GET['estimated_yield'];
...
// then insert loan
  ...
  if ($growerid>0) {
   ...
   $insert_sql = "INSERT INTO crop_population(userid, 
growerid, 
latitude, 
longitude, 
created_at, 
