...
if (isset($data->seasonid) && isset($data->userid) && isset($data->companyid) && isset($data->grower_num)  && isset($data->created_at)){
  ...
  $result = $conn->query($sql);
   ...
   if ($auction_grower==0 && $contracted_grower==0) {
     ...
     $user_sql = "INSERT INTO contracted_hectares(userid,seasonid,growerid,hectares,created) VALUES ($companyid,$seasonid,$growerid,'2','$created_at')";
