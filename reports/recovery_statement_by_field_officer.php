...
$sql2345 = "Select * from users where  active=1";
...
$sql2345 = "Select * from users where username='$description' and active=1 limit 1";
  $result2345 = $conn->query($sql2345);
