    ...
    <div class="main-menu menu-fixed menu-dark menu-bg-default rounded menu-accordion menu-shadow">
      <div class="main-menu-content"><a class="navigation-brand d-none d-md-block d-lg-block d-xl-block" href="index.php"><img class="brand-logo" alt="CryptoDash admin logo" src="app-assets/images/logo/logo.png"/></a>
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="active"><a href="performance.php"><i class="icon-layers"></i><span class="menu-title" data-i18n="">Performance</span></a>
          </li>
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">F.O Performance</h3>
                    ...
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <div class="progress progress-sm my-1 box-shadow-2">
                                    <div id="visited_percentage" class="progress-bar bg-warning" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="font-small-3 clearfix">
                                    <span class="float-left">Total Visited Growers <br> <strong id="visited_growers">500/1500</strong></span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card pull-up">
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form-horizontal form-purchase-token row" action="performance.html">
                                    ...
                                    <div class="col-md-3 col-12">
                                        <fieldset class="form-label-group mb-0">
                                            <input type="date" class="form-control" id="selected-crypto" value="1" required="" autofocus="">
...
function numberOfFieldOfficers() {
  // if (str.length==0) {
 //document.getElementById("totalRecoveredAmount").innerHTML="0.00 USD";
  ...
  xmlhttp.onreadystatechange=function() {
    if (this.readyState==4 && this.status==200) {
      document.getElementById("fieldOfficers").innerHTML=this.responseText;
  ...
  xmlhttp.open("GET","number_of_field_officers.php",true);
  xmlhttp.send();
...
let b="";
  ...
  xmlhttp.onreadystatechange=function() {
    ...
    document.getElementById("visited_percentage").style.width=this.responseText;
    b=this.responseText;
  ...
  xmlhttp.open("GET","total_visited_growers_percentage.php",true);
  xmlhttp.send();
...
function visitedGrowers() {
  // if (str.length==0) {
 document.getElementById("visited_growers").innerHTML="0";
  //   //document.getElementById("livesearch").style.border="0px";
  //   return;
  // }
  var xmlhttp=new XMLHttpRequest();
  xmlhttp.onreadystatechange=function() {
    if (this.readyState==4 && this.status==200) {
      document.getElementById("visited_growers").innerHTML=this.responseText ;
  ...
  xmlhttp.open("GET","total_visited_growers.php",true);
  xmlhttp.send();
